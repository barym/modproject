...
#define GROUND_EFFECT_FLAG_ASH_LONG_GRASS_ON_SPAWN  (1 << 20)
#define GROUND_EFFECT_FLAG_ASH_LONG_GRASS_ON_MOVE   (1 << 21)
#define GROUND_EFFECT_FLAG_LAND_IN_ASH_LONG_GRASS   (1 << 22)
