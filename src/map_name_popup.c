...
static const u8 sRegionMapSectionId_To_PopUpThemeIdMapping[] =
{
    ...
    [MAPSEC_ASRELIA_TOWN] = MAPPOPUP_THEME_WOOD,
    ...
    [MAPSEC_ELUSINA_CITY] = MAPPOPUP_THEME_BRICK,
    [MAPSEC_LIMANI_CITY] = MAPPOPUP_THEME_MARBLE,
    [MAPSEC_MAUVILLE_CITY] = MAPPOPUP_THEME_MARBLE,
    [MAPSEC_KENTRO_CITY] = MAPPOPUP_THEME_MARBLE,
    ...
    [MAPSEC_ROUTE_301] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_ROUTE_302] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_ROUTE_103] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_ROUTE_304] = MAPPOPUP_THEME_WOOD,
