...
static const u16 sRegionMap_SpecialPlaceLocations[][2] =
{
    ...
    {MAPSEC_PETALBURG_WOODS,            MAPSEC_ROUTE_304},
...
static const u8 sMapHealLocations[][3] =
{
    ...
    [MAPSEC_ASRELIA_TOWN] = {MAP_GROUP(ASRELIA_TOWN), MAP_NUM(ASRELIA_TOWN), HEAL_LOCATION_ASRELIA_TOWN},
    ...
    [MAPSEC_ELUSINA_CITY] = {MAP_GROUP(ELUSINA_CITY), MAP_NUM(ELUSINA_CITY), HEAL_LOCATION_ELUSINA_CITY},
    [MAPSEC_LIMANI_CITY] = {MAP_GROUP(LIMANI_CITY), MAP_NUM(LIMANI_CITY), HEAL_LOCATION_LIMANI_CITY},
    [MAPSEC_MAUVILLE_CITY] = {MAP_GROUP(MAUVILLE_CITY), MAP_NUM(MAUVILLE_CITY), HEAL_LOCATION_MAUVILLE_CITY},
    [MAPSEC_KENTRO_CITY] = {MAP_GROUP(KENTRO_CITY), MAP_NUM(KENTRO_CITY), HEAL_LOCATION_KENTRO_CITY},
    ...
    [MAPSEC_ROUTE_301] = {MAP_GROUP(ROUTE301), MAP_NUM(ROUTE301), HEAL_LOCATION_NONE},
    [MAPSEC_ROUTE_302] = {MAP_GROUP(ROUTE302), MAP_NUM(ROUTE302), HEAL_LOCATION_NONE},
    [MAPSEC_ROUTE_103] = {MAP_GROUP(ROUTE103), MAP_NUM(ROUTE103), HEAL_LOCATION_NONE},
    [MAPSEC_ROUTE_304] = {MAP_GROUP(ROUTE304), MAP_NUM(ROUTE304), HEAL_LOCATION_NONE},
...
static void RegionMap_InitializeStateBasedOnSSTidalLocation(void)
{
    ...
    case SS_TIDAL_LOCATION_SLATEPORT:
        sRegionMap->mapSecId = MAPSEC_LIMANI_CITY;
        break;
