static const struct HealLocation sHealLocations[] =
{
    ...
    [HEAL_LOCATION_ELUSINA_CITY - 1] = {MAP_GROUP(ELUSINA_CITY), MAP_NUM(ELUSINA_CITY), 13, 17},
    [HEAL_LOCATION_LIMANI_CITY - 1] = {MAP_GROUP(LIMANI_CITY), MAP_NUM(LIMANI_CITY), 26, 20},
    [HEAL_LOCATION_MAUVILLE_CITY - 1] = {MAP_GROUP(MAUVILLE_CITY), MAP_NUM(MAUVILLE_CITY), 22, 6},
    [HEAL_LOCATION_KENTRO_CITY - 1] = {MAP_GROUP(KENTRO_CITY), MAP_NUM(KENTRO_CITY), 26, 48},
    ...
    [HEAL_LOCATION_LITTLEROOT_TOWN_MAYS_HOUSE - 1] = {MAP_GROUP(LITTLEROOT_TOWN), MAP_NUM(LITTLEROOT_TOWN), 23, 9},
    [HEAL_LOCATION_ASRELIA_TOWN - 1] = {MAP_GROUP(ASRELIA_TOWN), MAP_NUM(ASRELIA_TOWN), 23, 20},
    [HEAL_LOCATION_DEWFORD_TOWN - 1] = {MAP_GROUP(DEWFORD_TOWN), MAP_NUM(DEWFORD_TOWN), 6, 26},
