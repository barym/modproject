...
const u16 gMetatiles_Kentro[] = INCBIN_U16("data/tilesets/secondary/kentro/metatiles.bin");
const u16 gMetatileAttributes_Kentro[] = INCBIN_U16("data/tilesets/secondary/kentro/metatile_attributes.bin");
